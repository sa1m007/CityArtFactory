...
$(document).ready(function() {
	...
	/*$('#dialog-message').hide();
	$('#dialog-confirm').hide();*/
	populateEvent('N','Domestic');			// ForthComing Event			  
	populateEvent('Y','Domestic');			// Past Event
	populateEvent('N','International');			// ForthComing Event			  
	populateEvent('Y','International');			// Past Event	
           ...
           success: function(userData)
           {
    		  ...
    		  for(i in eventDetails)
    			  { 
						...
						tempString = tempString + '<img src="images/programme/'+ image_name + '" alt=""></a>';
						...
						if(past_ind == 'Y' && event_typeValue == 'Domestic'){
							$("#past-domestic").append(tempString);
						}
						else if(past_ind == 'N' && event_typeValue == 'Domestic'){
							$("#forthcoming-domestic").append(tempString);	
						}
						else if(past_ind == 'Y' && event_typeValue == 'International'){
							$("#past-international").append(tempString);
						}
						else if(past_ind == 'N' && event_typeValue == 'International'){
							$("#forthcoming-international").append(tempString);	
						}
    			  }      		    		    
